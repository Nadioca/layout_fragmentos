...
public class BienvenidaFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Button buttonActividadAdicional = (Button) view.findViewById(R.id.buttonActividadAdicional);
        buttonActividadAdicional.setOnClickListener(new View.OnClickListener() {
            @Override
